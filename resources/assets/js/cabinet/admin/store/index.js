import MenuAreaVisibilities from './modules/Menu/menu_area_visibilities.js'
import ArbitraryLinks from './modules/Menu/arbitrary_links.js';
import Menu from './modules/Menu/menu.js';

export default {
    modules: {
        MenuAreaVisibilities,
        ArbitraryLinks,
        Menu
    },
    state: {
    ...
    getters: {
        ...
        optionsData: function (state) {
            return state.data.settings.options;
        }
    },
    mutations: {
        ...
        updateOptions(state, data) {
            state.data.settings.options = data;
        }
    }
}
