<template>
    <v-card>
        <v-card-title class="py-0 table-header__btn is-copy-control">
            ...
            <span class="mb-6 font-weight-regular user-info__title">Управление коллекциями</span>
            <v-spacer></v-spacer>
                    ...
                    <v-tooltip top>
                        <template v-slot:activator="{ on, attrs }">
                            <v-icon
                                v-bind="attrs"
                                v-on="on"
                                v-on:click="$emit('confirm', $event, {type:'deleteCollection', action: deleteCollection})"
                            >
                                mdi-delete
                            </v-icon>
                        </template>
    ...
    export default {
        ...
        methods: {
            ...
            copyItem: function() {
                ...
                axios.post(window.location.pathname +'/collection/copy', {
            ...
            deleteCollection: function(){
                ...
                axios.post('/home/collection/delete', data)
                    .then(() => {
