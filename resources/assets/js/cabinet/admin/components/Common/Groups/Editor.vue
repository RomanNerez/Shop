...
<script>
    ...
    import BaseForm from '../../Tabs/Groups/BaseForm.vue';
    import MetaForm from '../../Tabs/Groups/MetaForm.vue';
            ...
            editCategory: function(){
                ...
                .then((response) => {
                    setTimeout(() => {
                        ...
                        if (data.item) {
                            this.$store.commit(this.getMutation, this.action.section === 'groups' ? data.item : {
                                parent: input.parent,
