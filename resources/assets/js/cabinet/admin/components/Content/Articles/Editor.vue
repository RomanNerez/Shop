...
<script>
    import BaseForm from '../../Tabs/Articles/BaseForm.vue';
    import ChoseSubs from '../../Tabs/Articles/ChoseSubs.vue';
    import ContentEditor from '../../Tabs/ContentEditor.vue';
        ...
        methods: {
            ...
            send: function(){
                ...
                var s = this.selected,
                    ...
                    url = s ? path +'article/edit' : path +'article/create';
                ...
                .then((response) => {
                    setTimeout(() => {
                        ...
                        if (data.article) {
                            this.$store.commit('addArticle', data.article);
                        }else{
                            input.updated_at = data.updated_at;
                            this.$store.commit( 'editArticle', input);
                        }
                        this.editor = {
                            file: '',
                            slug: '',
