<template>
    <transition name="overlay">
        <div class="loading" v-if="show">
            <svg width="100%" height="100%" viewBox="0 0 340 70" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" xml:space="preserve" style="fill-rule:evenodd;clip-rule:evenodd;stroke-linejoin:round;stroke-miterlimit:1.41421;">
                <defs>
