...
<html>
    <head>
        <title>
            Modern an Admin Panel Category Flat Bootstarp Resposive Website
...
Smartphone Compatible web template, free webdesigns for Nokia, Samsung, LG, SonyErricsson, Motorola web design"
        ...
        <!-- Custom CSS -->
        <link href="{{asset('asset/css/style2.css')}}" rel="stylesheet" type="text/css" />
        <!-- Graph CSS -->
        <link href="{{asset('asset/css/lines.css')}}" rel="stylesheet" type="text/css" />
        ...
        <!-- Graph JavaScript -->
        <script src="{{asset('asset/js/d3.v3.js')}}"></script>
        <script src="{{asset('asset/js/rickshaw.js')}}"></script>
    </head>
    <body>
        <div id="wrapper">
            <!-- Navigation -->
            ...
            >
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="index.html"
                        >Freez <small>admin pannel</small>
                    </a>
                </div>
                <!-- /.navbar-header -->
                <ul class="nav navbar-nav navbar-right">
                    ...
                    <li class="dropdown">
                        <a
                            ...
                            data-toggle="dropdown"
                            ><img src="images/1.png" /><span class="badge"
                                >9</span
                            ></a
                        >
                        <ul class="dropdown-menu">
                        ...
                        <ul class="nav" id="side-menu">
                            <li>
                                <a href="{{route('admin-home')}}"
                                    ><i
                                        class="fa fa-dashboard fa-fw nav_icon"
                                    ></i
                                    >Dashboard</a
                                >
                            </li>
                            ...
                            <!--<li>
                                <a href="#"
                                    ><i class="fa fa-indent nav_icon"></i>Menu
                                    Levels<span class="fa arrow"></span
                                ></a>
                                <ul class="nav nav-second-level">
                                    <li>
                            ...
                            <!--<li>
                                <a href="#"
                                    ><i
                                        class="fa fa-check-square-o nav_icon"
                                    ></i
